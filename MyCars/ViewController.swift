...
//  MyCars
//
//  Created by Adel Gainutdinov on 19.09.2021.
//
...
class ViewController: UIViewController {
    ...
    private func update(rating: Double) {
        ...
        do {
            ...
            let alertController = UIAlertController(title: "Wrong value", message: "Wrong input value", preferredStyle: .alert)
    ...
    private func insertDataFrom(selectedCar car: Car) {
        ...
        numberOfTripsLabel.text = "Number if trips: \(car.timesDriven)"
    ...
    private func getDataFromFile() {
        ...
        for dictionary in dataArray {
            ...
            if let colorDictionary = carDictionary["tintColor"] as? [String : Float] {
                car.tintColor = getColor(from: colorDictionary)
            }
        }
    }
    
    private func getColor(from colorDictionary: [String : Float]) -> UIColor {
    ...
    override func viewDidLoad() {
        ...
        // if there is no data in DB, load it from plist file
        getDataFromFile()
    }
